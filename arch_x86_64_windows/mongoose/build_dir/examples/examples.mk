...
CFLAGS = -g -W -Wall -I/trunk/MediaProcessors_selfcontained/_install_dir_x86_64/include -L/trunk/MediaProcessors_selfcontained/_install_dir_x86_64/lib -lmongoose -Wno-unused-function $(CFLAGS_EXTRA) $(MODULE_CFLAGS)
