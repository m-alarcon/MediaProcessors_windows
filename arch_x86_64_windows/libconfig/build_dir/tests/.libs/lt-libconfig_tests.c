...
const char * LIB_PATH_VALUE   = "C:\\media_autobuild\\MediaProcessors_selfcontained\\arch_x86_64_windows\\libconfig\\build_dir\\lib\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:\\media_autobuild\\MediaProcessors_selfcontained\\arch_x86_64_windows\\libconfig\\build_dir\\tinytest;C:\\media_autobuild\\MediaProcessors_selfcontained\\arch_x86_64_windows\\libconfig\\build_dir\\lib\\.libs;C:\\media_autobuild\\MediaProcessors_selfcontained\\_install_dir_x86_64\\lib;C:\\media_autobuild\\MediaProcessors_selfcontained\\_install_dir_x86_64\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("  notinst_deplibs=' /trunk/MediaProcessors_selfcontained/arch_x86_64_windows/li", f);
  fputs ("bconfig/build_dir/lib/.libs/libconfig.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    PATH=/trunk/MediaProcessors_selfcontained/arch_x86_64_windows/libconfig/bui", f);
  fputs ("ld_dir/tinytest:/trunk/MediaProcessors_selfcontained/arch_x86_64_windows/libcon", f);
  fputs ("fig/build_dir/lib/.libs:/trunk/MediaProcessors_selfcontained/_install_dir_x86_6", f);
  fputs ("4/lib:/trunk/MediaProcessors_selfcontained/_install_dir_x86_64/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/trunk/MediaProcessors_selfcontained/arch_x86_64_windows/libconfig/bu", f);
  fputs ("ild_dir/lib/.libs:$PATH\"\n", f);
  fputs ("\n", f);
