...
const char * EXE_PATH_VALUE   = "C:\\media_autobuild\\MediaProcessors_selfcontained\\arch_x86_64_windows\\libconfig\\build_dir\\lib\\.libs;C:\\media_autobuild\\MediaProcessors_selfcontained\\_install_dir_x86_64\\lib;C:\\media_autobuild\\MediaProcessors_selfcontained\\_install_dir_x86_64\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("ld_dir/lib/.libs:/trunk/MediaProcessors_selfcontained/_install_dir_x86_64/lib:/", f);
  fputs ("trunk/MediaProcessors_selfcontained/_install_dir_x86_64/bin:$PATH\n", f);
  fputs ("\n", f);
