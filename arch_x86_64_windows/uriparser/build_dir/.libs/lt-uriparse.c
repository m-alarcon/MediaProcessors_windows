...
/* ./.libs/lt-uriparse.c - temporary wrapper executable for .libs/uriparse.exe
   Generated by libtool (GNU libtool) 2.4.6

   The uriparse program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "C:\\media_autobuild\\MediaProcessors_selfcontained\\arch_x86_64_windows\\uriparser\\build_dir\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:\\media_autobuild\\MediaProcessors_selfcontained\\arch_x86_64_windows\\uriparser\\build_dir\\.libs;C:\\media_autobuild\\MediaProcessors_selfcontained\\_install_dir_x86_64\\lib;C:\\media_autobuild\\MediaProcessors_selfcontained\\_install_dir_x86_64\\bin;";
const char * TARGET_PROGRAM_NAME = "uriparse.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# uriparse - temporary wrapper script for .libs/uriparse.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The uriparse program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ./liburiparser.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"uriparse.exe:uriparse:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"uriparse.exe:uriparse:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"uriparse.exe:uriparse:$LINENO: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
  ...
  fputs ("    PATH=/trunk/MediaProcessors_selfcontained/arch_x86_64_windows/uriparser/bui", f);
  fputs ("ld_dir/.libs:/trunk/MediaProcessors_selfcontained/_install_dir_x86_64/lib:/trun", f);
  fputs ("k/MediaProcessors_selfcontained/_install_dir_x86_64/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/trunk/MediaProcessors_selfcontained/arch_x86_64_windows/uriparser/bu", f);
  fputs ("ild_dir/.libs:$PATH\"\n", f);
  fputs ("\n", f);
