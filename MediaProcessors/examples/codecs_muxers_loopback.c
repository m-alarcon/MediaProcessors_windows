...
static void* http_server_thr(void *t)
{
	...
	//printf("Crea y configura el server\n"); fflush(stdout);

	memset(&opts, 0, sizeof(opts));
	//printf("Hace el memset\n"); fflush(stdout);
